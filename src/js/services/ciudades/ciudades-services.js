/**
* Clase controlador encargada del manejo de peticiones del recurso ciudades
* @table   ciudades
* @name    ciudades
* @class   
* @name    master-frontend.module.generadores.js.services.ciudades-services.js
* @mail    <a href= mailto:elias.dominguezpires@gmail.com@ejemplo.com.py>
* @author  <a> Elias Dominguez Pires </a>
 */
     app.factory('CiudadesServices', ['$http', 'SynchronousRequest',
             function ($http, synchronousRequestServices) {
                return {
                    ...
                    */
                    ...
                    /**
                     * Esta función obtiene un Recurso del Backend, lista de ciudades
                     * @param filtro
                     * @param inicio
                     * @param cantidad
                     * @param orderBy
