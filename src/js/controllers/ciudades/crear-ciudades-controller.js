...
*/
         ...
         */
         app.controller('CrearCiudadesController',
         [
            ...
            function ($scope, $route ,serviciosjqgrid, $location, $dialogs, alertServices, Navigator, $filter, $args, CiudadesServices) {
                 ...
                 *  @type {Object}
                 *  @field
                 *  @name master-frontend.module.generadores.js.controllers.crear-ciudades-controller.js#datos
                 */
                $scope.datos = {};
                ...
                $scope.confirmar = function () {
                    ...
                    CiudadesServices.insertar($scope.generarBodyData($scope.datos), 'ciudades')
                        .then(
                        function (response) {
                            try {
