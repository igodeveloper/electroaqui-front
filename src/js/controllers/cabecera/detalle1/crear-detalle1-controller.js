/**
* Modulo controlador para la crearción de recursos detalle1
* @table    detalle1
* @class
* @name     master-frontend.module.generadores.js.controllers.detalle1-controller.js
*
...
*/
        ...
        */
        app.controller('CrearDetalle1Controller',
        [
           ...
           function ($scope, $route ,serviciosjqgrid, $location, $dialogs, alertServices, Navigator, $filter, $args, ModuloEjemploServices) {
                ...
                *  @type {Object}
                *  @field
                *  @name master-frontend.module.generadores.js.controllers.crear-detalle1-controller.js#datos
                */
               $scope.datos = {};
               
               $scope.generarBodyData = function(datos){
				    var bodyData = {
				        cabeCodigo: datos.cabeCodigo,
				        det1Descripcion: datos.det1Descripcion,
				        det1Codigo: datos.det1Codigo,
				    }
				    return bodyData;
				};
                ...
                * @function confirmar()
                * @public
                * @name master-frontend.module.generadores.js.controllers.crear-detalle1-controller.js#confirmar
                */
               $scope.confirmar = function () {
               
                   $scope.uiBlockuiConfig.bloquear = true;
                   Detalle1Services.insertar($scope.generarBodyData($scope.datos), 'detalle1')
                       .then(
                       function (response) {
                           try {
                ...
                * @function cancelar()
                * @public
                * @name master-frontend.module.generadores.js.controllers.crear-detalle1-controller.js#cancelar
                */
